...
componentDidMount()
  ...
  trapezoidal=()=>{
    ...
    var cal = (((b-a)/2)*((this.Solve(eq,b)+this.Solve(eq,a))));
        ...
        <Layout className="site-layout">
          ...
          <Content style={{ margin: '0 16px' }}>
            <Breadcrumb style={{ margin: '16px 0' }}>
              ...
              <Breadcrumb.Item>Trapezoidal's Rule</Breadcrumb.Item>
            </Breadcrumb>
            
            <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
              TRAPEZOIDAL'S RULE<br/><br/>
              <div>
              ...
              <div>
                <Button type="primary" onClick={this.trapezoidal}>Submit</Button>
              </div>
              <br />
